...
validated as (
    ...
    select
        b.*
    from base b
    inner join gold.dim_zone puz
        on b.pu_zone_key = puz.zone_key
    inner join gold.dim_zone doz
